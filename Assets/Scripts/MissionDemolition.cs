...
public class MissionDemolition : MonoBehaviour
{
    ...
    public TextMeshProUGUI uitLevel;    // Ссылка на объект UIText_Level
    public TextMeshProUGUI uitShots;    // Ссылка на объект UIText_Shots
    public TextMeshProUGUI uitButton;   // Ссылка на дочерний объект Text в UIButton_View
